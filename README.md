...
**Установите основной пакет (`all.ipk` версия) в зависимости от того, где находится файл.**
...
**Установите основной пакет (`all.apk` версия) в зависимости от того, где находится файл.**
...
1. **Сначала установите основной пакет (`all` версия), с флагом**
